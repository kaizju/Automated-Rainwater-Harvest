...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        logActivity('login', 'failed', 'auth', 'Failed login attempt for: ' . $email);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-header p { color: #64748b; font-size: .875rem; }
        ...
        .login-btn:disabled { background: #93c5fd; pointer-events: none; }
        ...
        .card-footer-note { text-align: center; font-size: .78rem; color: #94a3b8; margin-top: .5rem; }
...
<body>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function (e) {
            ...
            if (!pwd)            { showErr('passwordGroup', 'passwordError', 'Password is required.');    ok = false; }
            else if (pwd.length < 6) { showErr('passwordGroup', 'passwordError', 'At least 6 characters.'); ok = false; }
