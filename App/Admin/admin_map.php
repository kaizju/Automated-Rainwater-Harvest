...
<div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="<?php echo BASE_URL; ?>/App/Admin/admin_dashboard.php" class="nav-item">
        ...
        <a href="<?php echo BASE_URL; ?>/App/Admin/admin_usage.php" class="nav-item">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?php echo BASE_URL; ?>/App/Admin/admin_weather.php" class="nav-item">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
