...
.sidebar-logo { display: flex; align-items: center; gap: .65rem; padding: .25rem .5rem .25rem .25rem; margin-bottom: 2rem; }
.logo-drop { width: 34px; height: 34px; background: linear-gradient(160deg,#60a5fa 10%,#2563eb 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.05rem; flex-shrink: 0; }
.logo-name { font-family: 'Space Grotesk', sans-serif; font-size: 1.1rem; font-weight: 700; color: #fff; letter-spacing: -.01em; }
.nav-section { flex: 1; display: flex; flex-direction: column; gap: .1rem; }
.nav-link { display: flex; align-items: center; gap: .75rem; padding: .62rem .9rem; border-radius: 8px; font-size: .875rem; font-weight: 500; color: #94a3b8; text-decoration: none; transition: background .15s, color .15s; }
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="nav-section">
    <a href="<?= BASE_URL ?>/App/Manager/manager.php" class="nav-link">
    ...
    <a href="<?= BASE_URL ?>/App/Manager/usage.php" class="nav-link">
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
      Usage Stats
    </a>
    <a href="<?= BASE_URL ?>/App/Manager/weather.php" class="nav-link">
    ...
    <a href="<?= BASE_URL ?>/App/Manager/map.php" class="nav-link">
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
      Tank Map
    </a>
    <a href="<?= BASE_URL ?>/App/Manager/settings.php" class="nav-link active">
  ...
  <div class="sidebar-footer">
    <a href="<?= BASE_URL ?>/Connections/signout.php" class="nav-link logout">
